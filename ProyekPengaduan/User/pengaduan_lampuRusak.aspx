<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengaduan_lampuRusak.aspx.vb" Inherits="Login_pengaduan" Theme="User" %>
...
<body>
    ...
    <section class="section1">
        <h1>Pengaduan Lampu Jalan Rusak</h1>

        <div class="row justify-content-center">
            <div class="col-lg-6">
                <table class="table table-borderless">
                    <tr>
                        <td class="style2">sss</td>
                        <td class="style1">
