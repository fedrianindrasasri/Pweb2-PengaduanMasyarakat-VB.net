<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengaduan_kemacetan.aspx.vb" Inherits="Login_pengaduan" Theme="User" %>
...
<body>
    ...
    <section class="section1">
        <h1>Pengaduan Kemacetan</h1>

        <div class="row justify-content-center">
            <div class="col-lg-6">
                <table class="table table-borderless">
                    <tr>
                        <td class="style4">NIK</td>
                        <td class="style2">
    ...
    <footer class="bg-dark">
        <div class="container text-center">
            <div class="row">
                <div class="col-sm-12">
                    <p>Copyright &copy; Fedrian Indra Sasri | Fitra Ramadhan                 <p>Pemrograman Web 2 | ASP.NET</p>
                </div>
            </div>
        </div>
    </footer>
