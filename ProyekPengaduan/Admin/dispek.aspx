<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dispek.aspx.vb" Inherits="index" MasterPageFile="~/Pengaduan.master" %>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--green">
                                <h2 class="number"><asp:Label ID="lbljalan" runat="server" Text="Label"></asp:Label></h2>
                                <span class="desc">Jalan Rusak</span>
                                <div class="icon">
