<%@ Page Language="VB" AutoEventWireup="false" CodeFile="diskeb.aspx.vb" Inherits="index" MasterPageFile="~/Pengaduan.master" %>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--green">
                                <h2 class="number"><asp:Label ID="lblsampah" runat="server" Text="Label"></asp:Label></h2>
                                <span class="desc">Sampah</span>
                                <div class="icon">
