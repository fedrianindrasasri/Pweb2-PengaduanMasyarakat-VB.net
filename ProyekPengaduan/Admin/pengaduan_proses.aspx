<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pengaduan_proses.aspx.vb" Inherits="table" MasterPageFile="~/Pengaduan.master"%>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
        ...
        <section class="welcome p-t-10">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="title-4">Pengaduan yang Sedang Diproses
                        </h1>
