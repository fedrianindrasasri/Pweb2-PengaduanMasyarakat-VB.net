<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dispas.aspx.vb" Inherits="index" MasterPageFile="~/Pengaduan.master" %>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--green">
                                <h2 class="number"><asp:Label ID="lblkaki" runat="server" Text="Label"></asp:Label></h2>
                                <span class="desc">Kaki lima</span>
                                <div class="icon">
                       ...
                       <%-- <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--orange">
                                <h2 class="number"><asp:Label ID="lblparkir" runat="server" Text="Label"></asp:Label></h2>
                                <span class="desc">Parkir</span>
                                <div class="icon">
