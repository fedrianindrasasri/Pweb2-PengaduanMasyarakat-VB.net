...
Partial Class index
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim rokok As String = "SELECT COUNT(*)AS Row_Count FROM pengaduan where id_kat_pengaduan='11'"
        Dim Conn As New SqlConnection(strConn)
        Dim Cmd As New SqlCommand(rokok, Conn)
        Conn.Open()
        Dim Count As Integer = Convert.ToInt32(Cmd.ExecuteScalar())
        lblrokok.Text = Count.ToString
        Conn.Close()
        ...
        Dim baru As String = "SELECT COUNT(*)AS Row_Count FROM pengaduan where status='Diajukan' and id_kat_pengaduan='11' "
            ...
            For Each row As DataRow In dt.Rows
                ...
                For Each column As DataColumn In dt.Columns
                    ...
                    If column.ColumnName.Equals("status") Then
                        ...
                        html.Append("<td><div class='table-data-feature'><a href='../diskes.ashx?ID=" & keren & "'><button id='test' class='item' data-toggle='tooltip' data-placement='top' title='Proses' ><i class='zmdi zmdi-mail-send'></i></button> <a href='../diskes1.ashx?ID=" & keren & "'> <button id='test' class='item' data-toggle='tooltip' data-placement='top' title='Selesai' ><i class='zmdi zmdi-edit'></i></button>  </div></td>")
    ...
    Private Function GetData() As DataTable
        ...
        Using con As New SqlConnection(constr)
            Using cmd As New SqlCommand("SELECT id_pengaduan,nik,tgl_pengaduan,deskripsi_pengaduan,status FROM pengaduan where id_kat_pengaduan='11'  ")
